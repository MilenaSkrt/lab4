...
public:
    void Add(int a) override { /* реализация */ }
    void Insert(int a, int pos) override { /* реализация */ }
    void Delete(int pos) override { /* реализация */ }
    void Clear() override { /* реализация */ }
    int& operator[](int i) override { /* реализация */ }

    BaseList* EmptyClone() override { return new ArrList(); }
};
...
public:
    ...
    BaseList* EmptyClone() override { return new ChainList(); }
};
